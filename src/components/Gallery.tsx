...
const photos = [
  { src: '/gallery/cathedral-park (1).jpg', alt: 'Cathedral Park Photo 1' },
  { src: '/gallery/cathedral-park (2).jpg', alt: 'Cathedral Park Photo 2' },
  { src: '/gallery/cathedral-park (3).jpg', alt: 'Cathedral Park Photo 3' },
  { src: '/gallery/cathedral-park (4).jpg', alt: 'Cathedral Park Photo 4' },
  { src: '/gallery/cathedral-park (5).jpg', alt: 'Cathedral Park Photo 5' },
  { src: '/gallery/cathedral-park (6).jpg', alt: 'Cathedral Park Photo 6' },
  { src: '/gallery/cathedral-park (7).jpg', alt: 'Cathedral Park Photo 7' },
  { src: '/gallery/cathedral-park (8).jpg', alt: 'Cathedral Park Photo 8' },
  { src: '/gallery/cathedral-park (9).jpg', alt: 'Cathedral Park Photo 9' },
  { src: '/gallery/cathedral-park (10).jpg', alt: 'Cathedral Park Photo 10' },
  { src: '/gallery/cathedral-park (11).jpg', alt: 'Cathedral Park Photo 11' },
  { src: '/gallery/cathedral-park (12).jpg', alt: 'Cathedral Park Photo 12' },
  { src: '/gallery/cathedral-park (13).jpg', alt: 'Cathedral Park Photo 13' },
  { src: '/gallery/cathedral-park (14).jpg', alt: 'Cathedral Park Photo 14' },
  { src: '/gallery/cathedral-park (15).jpg', alt: 'Cathedral Park Photo 15' },
  { src: '/gallery/cathedral-park (16).jpg', alt: 'Cathedral Park Photo 16' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              ...
              <a
                href="https://maps.app.goo.gl/dq2NxwG4w3bssWNw9"
                target="_blank"
